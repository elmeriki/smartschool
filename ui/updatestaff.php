...
<div class="container_fluid">
    <!-- <h1 class="well">Register New Teacher/Staff</h1> -->
    <p class="page-header"> 
    <strong>Update Teacher/Staff Account</strong><br>
	...
	<div class="row">
				<form>
					...
					<div class="form-group">
						...
						<input type="text" placeholder="This will be auto Generated.." class="form-control">
					</div>
